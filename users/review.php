...
?>
            ...
            <div class="container-xxl py-5 bg-dark hero-header mb-5">
                <div class="container text-center my-5 pt-5 pb-4">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Review Us</h1>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-6 bg-dark d-flex align-items-center">
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <h1 class="text-white mb-4">Review Us</h1>
                        <form method="POST" action="review.php">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <button name="submit" type="submit" class="btn btn-primary w-100 py-3">Submit Review</button>
                                </div>
                            </div>
                        </form>
                    </div>
